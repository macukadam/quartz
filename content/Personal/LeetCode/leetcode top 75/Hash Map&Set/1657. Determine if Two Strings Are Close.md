---
publish: true
created: 2026-02-07T01:11:06.718+01:00
...
def determine_if_two_strings_are_close(str1: str, str2: str) -> bool:
    ...
    is_same_val = sorted(hash1.values()) == sorted(hash2.values())

    return set(hash1.keys()) == set(hash2.keys()) and is_same_val
```
...
res = determine_if_two_strings_are_close(word1, word2)
print(res)
```
