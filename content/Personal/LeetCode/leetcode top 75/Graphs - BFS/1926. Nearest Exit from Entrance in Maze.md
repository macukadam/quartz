---
publish: true
created: 2026-02-07T01:31:30.282+01:00
modified: 2026-02-07T01:31:30.282+01:00
cssclasses: ""
---
...
![[Personal/LeetCode/Assets/LetCode Assets/nearest-exit-from-entrance-in-maze_0.jpg]]
...
![[Personal/LeetCode/Assets/LetCode Assets/nearest-exit-from-entrance-in-maze_1.jpg]]
...
![[Personal/LeetCode/Assets/LetCode Assets/nearest-exit-from-entrance-in-maze_2.jpg]]
...
Check if we're at the border and not at the entrance — this is our exit condition. To track visited locations, we can mark "." cells as "+" in-place. Both BFS and DFS would work here with O(n × m) time complexity in the worst case, but BFS is the natural choice for shortest path problems since it explores level by level.
...
def nearest_exit_from_maze(maze: List[List[str]], entrance: List[int]) -> int:
    ...
    while queue:
        for _ in range(len(queue)):
            x, y = queue.popleft()
            if (x == 0 or y == 0 or x == n - 1 or y == m - 1) and entrance != [x, y]:
                return steps
...
print(nearest_exit_from_maze(maze = [["+","+",".","+"],[".",".",".","+"],["+","+","+","."]], entrance = [1,2]))
print(nearest_exit_from_maze(maze = [["+","+","+"],[".",".","."],["+","+","+"]], entrance = [1,0]))
print(nearest_exit_from_maze(maze = [[".","+"]], entrance = [0,0]))
```
